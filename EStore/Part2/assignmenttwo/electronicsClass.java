...
public class electronicsClass extends productClass {
     ...
     */
    public electronicsClass(String electronicMaker, String electronicType, String itemPrice, String itemName, String itemYear, String itemID) {
     ...
     * @param itemID calls super to get item ID from the extended class
     */
    public electronicsClass(String electronicMaker, String electronicType, String itemName, String itemYear, String itemID) {
