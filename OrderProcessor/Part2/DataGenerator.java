...
public class DataGenerator {
    ...
    /**
     * This method provides a random computer party order, containing parameter 'size' times objects allowed in the order.
     * @return A random computerparty order object
     */
    public ComputerPartyOrder randomComputerPartyOrder(int size) {
        ComputerPartyOrder order = new ComputerPartyOrder();
